...
public class MemoryVacancyRepository implements VacancyRepository {
    ...
    public MemoryVacancyRepository() {
        ...
        save(new Vacancy(0, "Middle+ Java Developer", "description for Middle+ Java Developer", true, 2, 0));
        save(new Vacancy(0, "Senior Java Developer", "description for Senior Java Developer", true, 1, 0));
    }
    ...
    public boolean update(Vacancy vacancy) {
        return vacancies.computeIfPresent(vacancy.getId(),
                (id, oldValue) -> new Vacancy(oldValue.getId(), vacancy.getTitle(), vacancy.getDescription(),

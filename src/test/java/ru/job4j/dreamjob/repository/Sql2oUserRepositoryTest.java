...
class Sql2oUserRepositoryTest {
    ...
    public void whenSaveTwoUserThenGetSame() {
        var user1 = sql2oUserRepository.save(new User(0, "1@mail", "1Name", "1qwerty"));
        var user2 = sql2oUserRepository.save(new User(0, "2@mail", "2Name", "2qwerty"));
        var savedUser1 = sql2oUserRepository.findByEmailAndPassword("1@mail", "1qwerty");
        var savedUser2 = sql2oUserRepository.findByEmailAndPassword("2@mail", "2qwerty");
